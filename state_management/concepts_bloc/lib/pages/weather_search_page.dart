...
import 'package:concepts_bloc/data/model/weather.dart';

class WeatherSearchPage extends StatefulWidget {
  const WeatherSearchPage({super.key});

  @override
  WeatherSearchPageState createState() => WeatherSearchPageState();
}

class WeatherSearchPageState extends State<WeatherSearchPage> {
  @override
